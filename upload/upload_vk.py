"""
Upload videos to VK (VKontakte) - PiffTok Lens
"""
import os
import vk_api
...
def upload_to_vk(video_path, description="", title=""):
    ...
    try:
        ...
        message = description if description else "PiffTok Lens - Michelle Pfeiffer Moments!\n\n#michellepfeiffer #hollywood #celebrity #fashion"
        ...
        video = upload.video(
            ...
            name=title or 'PiffTok Lens Video',
